...
## Про задание для терминаторов

Я попытался разобраться как это делать, но честно говоря не смог полностью разобраться в подключении сервера, поэтому даже не пытался его сделать